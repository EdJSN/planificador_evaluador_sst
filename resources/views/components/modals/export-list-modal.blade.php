    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header Azlo-light">
                <h5 class="modal-title text-white d-block mx-auto" id="exportListModalLabel">Correlacionar actividades
                </h5>
            </div>
            <div class="modal-body text-start">
                <form id="exportListForm" action="{{ route('planner.export') }}" method="POST">
                    ...
                    <!-- Selección del tipo -->
                    <div class="mb-3">
                        <label class="form-label d-block">Tipo de exportación</label>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="tipo_individual" name="tipo"
                                value="individual" checked>
                            <label class="form-check-label" for="tipo_individual">Individual</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="tipo_grupo" name="tipo"
                                value="grupo">
                            <label class="form-check-label" for="tipo_grupo">Grupal</label>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="actividad_grupo" class="mb-3 d-none">
                            <x-forms.select label="Actividades" id="activity_ids_group" name="activity_ids[]"
                                col="col-md-12" class="js-tomselect form-select" :options="$activityOptions" multiple />
                        </div>
                    </div>
                </form>
            </div>
